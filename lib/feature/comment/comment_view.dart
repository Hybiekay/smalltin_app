...
class CommentBottomView extends StatefulWidget {
  final HistoryStat user;

  const CommentBottomView({super.key, required this.user});

  @override
  CommentBottomViewState createState() => CommentBottomViewState();
}

class CommentBottomViewState extends State<CommentBottomView> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                userController.userModel?.profile != null
                    ? CircleAvatar(
                        backgroundImage: NetworkImage(ApiString.imageUrl(
                            userController.userModel?.profile ?? "")),
                        radius: 20,
                      )
            ...
            Text(
              'Comments for ${userController.userModel?.username}',
